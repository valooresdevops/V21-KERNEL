...
@Entity
@Table(name = "V21_SIGNATURE", schema = TECHDBA)
@Getter
@Setter

public class V21SignatureModel {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="S_V21_Files_ID")
	@SequenceGenerator(name = "S_V21_SIGNATURE", schema = "TECHDBA", sequenceName = "S_V21_SIGNATURE", allocationSize = 1)
